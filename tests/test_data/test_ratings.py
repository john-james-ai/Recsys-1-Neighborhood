...
# Modified   : Sunday January 29th 2023 08:54:12 am                                                #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
class TestRatingsDataset:  # pragma: no cover
    ...
    def test_properties(self, ratings, caplog):
        ...
        assert isinstance(ratings.size, np.int64)
        assert isinstance(ratings.users, int)
        assert isinstance(ratings.items, int)
