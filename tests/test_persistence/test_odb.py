...
class TestODB:  # pragma: no cover
    ...
    # ============================================================================================ #
    def test_insert(self, ratings, caplog):
        start = datetime.now()
        logger.info(
            "\n\nStarted {} {} at {} on {}".format(
                self.__class__.__name__,
    ...
    # ============================================================================================ #
    def test_select(self, ratings, caplog):
        start = datetime.now()
        logger.info(
            "\n\nStarted {} {} at {} on {}".format(
                self.__class__.__name__,
    ...
    # ============================================================================================ #
    def test_selectall(self, ratings, caplog):
        start = datetime.now()
        logger.info(
            "\n\nStarted {} {} at {} on {}".format(
                self.__class__.__name__,
        ...
        for i in range(1, 6):
            ...
            value = ratings
            odb.insert(key=key, value=value)

        objects = odb.selectall()
    ...
    # ============================================================================================ #
    def test_update(self, ratings, caplog):
        start = datetime.now()
        logger.info(
            "\n\nStarted {} {} at {} on {}".format(
                self.__class__.__name__,
        ...
        odb = ObjectDB(filepath=TEST_DATABASE)
        odb.insert(key="ratings", value=ratings)
        odb.update(key="ratings", value=data)
    ...
    # ============================================================================================ #
    def test_delete(self, ratings, caplog):
        start = datetime.now()
        logger.info(
            "\n\nStarted {} {} at {} on {}".format(
                self.__class__.__name__,
    ...
    # ============================================================================================ #
    def test_exists_clear(self, ratings, caplog):
        start = datetime.now()
        logger.info(
            "\n\nStarted {} {} at {} on {}".format(
                self.__class__.__name__,
        ...
        for i in range(1, 6):
            key = "test_dataframe_" + str(i)
            assert odb.exists(key)

        odb.clear()

        for i in range(1, 6):
            key = "test_dataframe_" + str(i)
            assert not odb.exists(key)
